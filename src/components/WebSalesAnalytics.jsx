...
const data = [
  {
    name: "Twitter",
    value: 456,
    href: "https://twitter.com/lagoslabs",
  ...
  },
  {
    name: "Google",
    value: 351,
    href: "https://google.com/lagoslabs",
  ...
  },
  {
    name: "GitHub",
    value: 271,
    href: "https://github.com/lagoslabs",
  ...
  },
  {
    name: "Youtube",
    value: 91,
    href: "https://www.youtube.com/@lagoslabs",
...
const WebSalesAnalytics = () => {
  return (
    <Card className="max-w-full my-4">
      <h3 className="text-tremor-title text-tremor-content-strong dark:text-dark-tremor-content-strong font-medium">Website Sales Analytics</h3>
...
export default WebSalesAnalytics;
